...
VALUES
  (1, 'DUI/NIT del Empleador', 0614200595, 'DUIN');
INSERT INTO parameters (id, name, value, type)
VALUES
  (2, 'Número patronal ISSS', 12345678, 'NPIS');
INSERT INTO parameters (id, name, value, type)
VALUES
  (3, 'Correlativo Centro de Trabajo ISSS', 876543, 'CCTS');
INSERT INTO parameters (id, name, value, type)
VALUES
  (4, 'Nombre de la empresa', 1, 'COMP');
